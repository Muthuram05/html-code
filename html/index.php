...
<body>
    ...
    <div class="d-flex section">
        <div class="d-flex flex-column w-200 bg-dark section-left">
            <!-- <a href="index1.html" class="text-decoration-none py-4 px-3 active text-white" data-content="">Home</a> -->
            <a href="index.php" class="text-decoration-none py-4 px-3 active text-white active" data-content="index">Home</a>
        ...
        <div class="section-right" id="content-area">
            <img src="assets/image.png" alt="Welcome Image" style="width: 700px; height: 600px;" />
